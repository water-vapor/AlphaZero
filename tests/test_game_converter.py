...
class TestGameConverter(unittest.TestCase):
	...
	def setUp(self):
		...
		self.test_data_handicap = [os.path.join(test_data_handicap_path, n) for n in os.listdir(test_data_handicap_path)]
	...
	def test_sgf_to_hdf5(self):
		try:
			c.sgfs_to_hdf5(self.test_data, 'test_normal.h5', 19)
			c.sgfs_to_hdf5(self.test_data_handicap, 'test_handicap.h5', 19)
