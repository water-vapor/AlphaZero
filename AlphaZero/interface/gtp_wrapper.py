...
class GTPGameConnector(object):
    ...
    def get_move(self, color):
        ...
        move = self._get_move(self._state)
...
def run_gtp(get_move, inpt_fn=None, name="Gtp Player", version="0.0"):
    gtp_game = GTPGameConnector(get_move)
